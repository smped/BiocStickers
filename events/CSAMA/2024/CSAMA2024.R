...
img <- readPNG("images/CSAMA2024.png")
...
hex <- ggplot() +
    ...
    geom_url(url = "CSAMA2024", x = 0.23, y = 1.25,
    ...
    geom_url(url = "www.bioconductor.org", size = 7, color = "#ffffff",
             x = 0.95, y = 0.11) +
    theme_sticker()
ggsave("CSAMA2024.png", plot = hex, width = 43.9,
...
hex <- ggplot() +
    ...
    hex_segment2(size = 0, fill = col_border,
                 from_radius = 0.94, to_radius = 1,
                 from_angle = 270, to_angle = 330) +
    geom_url(url = "CSAMA2024", x = 0.24, y = 1.31,
    ...
    geom_url(url = "www.bioconductor.org", size = 18, color = "#ffffff",
             x = 1, y = 0.13) +
    theme_sticker()
ggsave("CSAMA2024-tshirt.png", plot = hex, width = 12.098,
...
hex <- ggplot() +
    ...
    geom_url(url = "www.bioconductor.org", size = 7, color = "#ffffff",
             x = 0.95, y = 0.11) +
    theme_sticker()
ggsave("CSAMA2024-a.png", plot = hex, width = 43.9,
       height = 50.8, units = "mm", bg = "transparent", dpi = 300,
       type = "cairo-png", antialias = "subpixel")
...
hex <- ggplot() +
    ...
    geom_url(url = "www.bioconductor.org", size = 7, color = "#ffffff",
             x = 0.95, y = 0.11) +
    theme_sticker()
ggsave("CSAMA2024-b.png", plot = hex, width = 43.9,
       height = 50.8, units = "mm", bg = "transparent", dpi = 300,
       type = "cairo-png", antialias = "subpixel")
